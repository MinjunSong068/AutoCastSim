...
def main():
    ...
    parser.add_argument('--host',
                        help='IP of the host server', default="192.168.50.231")
    ...
    parser.add_argument('--route', help='Run a route as a scenario', type=str, default="srunner/examples/DistributedMultiEgoVehicle_coopernaut.xml")
