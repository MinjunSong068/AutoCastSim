...
from AutoCastSim.ScenarioRunner.srunner.scenariomanager.scenarioatomics.atomic_behaviors import AtomicBehavior
from AutoCastSim.ScenarioRunner.srunner.tools.scenario_helper import get_same_dir_lanes, get_opposite_dir_lanes
...
class BackgroundBehavior(AtomicBehavior):
    ...
    def _initialise_road_behavior(self, road_wps):
        ...
        for wp in road_wps:
            ...
            # Spawn actors
            print("initialise_road_behavior")
    ...
    def _initialise_junction_exits(self, junction):
        ...
        for wp in exit_wps:
            ...
            if exit_lane_key in route_exit_keys:
                print("initialise_junction_exits")
            ...
            if not self._scenario_junction_entry:
                ...
                for new_wp in list(new_wps):
                    ...
                    for _ in range(self._road_front_vehicles):
                        ...
                        next_wp = next_wps[0]
                        spawn_wps.insert(0, next_wp)
                    print("_monitor_topology_changes")
                    actors = self._spawn_actors(spawn_wps)
