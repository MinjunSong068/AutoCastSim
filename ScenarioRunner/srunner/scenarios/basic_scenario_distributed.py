...
class BasicScenario(object):
    ...
    def __init__(self, name, ego_vehicles, configs, world,
        ...
        self.route_mode = bool(configs[0].route)
        ...
        self._initialize_actors(configs)
        ...
        #TODO: Check if trigger point is read correctly 
        trigger_behavior = self._setup_scenario_trigger(configs[0])
        if trigger_behavior:
        ...
        end_behavior = self._setup_scenario_end(configs[0])
        if end_behavior:
    ...
    def _initialize_actors(self, configs):
        """
