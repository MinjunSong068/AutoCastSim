...
class AutoCastIntersectionRedLightViolation(BasicScenario):
    ...
    def _create_behavior(self):
        ...
        # if len(self.config.other_actors) > 0:
        ...
        for ego_vehicle in self.ego_vehicles:
            ego_drive_distance = DriveDistance(ego_vehicle, self._ego_vehicle_driven_distance)
    ...
    def _create_test_criteria(self):
        ...
        for ego_vehicle in self.ego_vehicles:
            collision_criterion_ego = CollisionTest(ego_vehicle)
            driven_distance_criterion = DrivenDistanceTest(
                ego_vehicle, self._ego_vehicle_driven_distance)
