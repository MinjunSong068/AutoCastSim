...
from AutoCastSim.ScenarioRunner.srunner.scenarioconfigs.route_scenario_configuration_distributed import RouteScenarioConfiguration
from AutoCastSim.ScenarioRunner.srunner.scenarioconfigs.scenario_configuration_distributed import ScenarioConfiguration, ActorConfigurationData
    ...
    def parse_routes_file(route_filename, single_route_id=''):
        ...
        for scenario in tree.iter("scenario"): 
            ...
            for route in scenario.find("routes").iter("route"):
                scenario_config_route = scenario_config
                ...
                route_config.ego_vehicles.append(ActorConfigurationData.parse_from_node(ego_vehicle, ego_vehicle.attrib["rolename"]))
                route_config.agent_type = ego_vehicle.attrib["agent"]
                ...
                route_config.scenario_configs = [scenario_config_route]
